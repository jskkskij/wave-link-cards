...
const AdSenseBanner = () => {
    ...
    return (
        <section className="py-4 md:py-8 bg-secondary/5 border-y border-white/5 flex justify-center overflow-hidden transition-all duration-500">
            <div className="container mx-auto px-4 flex justify-center w-full max-w-4xl">
                 ...
                 */}
                <div className="w-full min-h-[100px] flex justify-center items-center bg-black/5 rounded-lg overflow-hidden">
