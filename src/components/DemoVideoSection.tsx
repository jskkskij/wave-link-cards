...
const DemoVideoSection = () => {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener('blur', handleFocusCheck);
  }, []);
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-5xl mx-auto animate-fade-in-up">
          <div className="relative group">
            ...
            <div className={`absolute -inset-1 bg-gradient-luxury rounded-2xl blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-500 ${isPlaying ? 'opacity-0' : ''}`}></div>
            ...
            <div
              className={`absolute inset-0 flex items-center justify-center pointer-events-none transition-opacity duration-300 ${isPlaying ? 'opacity-0' : 'group-hover:opacity-0 group-focus-within:opacity-0'}`}
              aria-hidden="true"
            >
