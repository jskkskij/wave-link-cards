...
import { Check, ShieldCheck, Lock, Users, Clock, TrendingUp, Zap, ArrowRight } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="order-1 md:order-2">
            <Card className="relative p-8 border-2 border-primary/40 shadow-luxury bg-gradient-to-br from-card to-card/50 backdrop-blur-sm animate-fade-in-up overflow-visible">
              ...
              <div className="text-center mb-6">
                <div className="mb-4">
                  ...
                  <div className="flex items-baseline justify-center gap-2">
                    <span className="text-7xl md:text-8xl font-bold text-primary">৳599</span>
                    <span className="text-xl text-muted-foreground">BDT</span>
                  </div>
                  <p className="text-sm text-muted-foreground mt-2">One-time payment • No hidden fees</p>
                </div>
              </div>
              ...
              {/* Risk Reversal */}
              <div className="bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/20 rounded-lg p-4 mb-6 text-center">
                <p className="text-sm font-semibold text-foreground mb-1">💰 Start with 50% down</p>
                <p className="text-xs text-muted-foreground">Pay only ৳300 now, rest on delivery</p>
              </div>
