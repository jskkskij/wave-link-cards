  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Semantic Aliases for Zen Theme
        navy: {
      ...
      animation: {
        ...
        "float-intense": "float-intense 5s ease-in-out infinite",
      ...
      backgroundImage: {
        ...
        'zen-gradient': 'linear-gradient(to top, hsl(var(--background)), hsl(var(--card)))',
      }
    },
  },
